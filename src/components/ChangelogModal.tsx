...
export default function ChangelogModal({ onClose }: Props) {
  return createPortal(
    <div
      ...
      role="presentation"
    >
      <div className="relative w-full max-w-lg max-h-[80vh] overflow-y-auto rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-xl">
