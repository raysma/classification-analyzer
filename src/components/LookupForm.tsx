    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 max-w-md">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
